...
# Rutas de archivos - usar rutas relativas
...
def initialize_model():
    ...
    try:
        ...
        # Generar gráficas
        plt.style.use('default')  # Cambiar a tema por defecto para Railway
        ...
        print("✅ Modelo y métricas inicializados correctamente")
...
# El servidor se ejecuta con: uvicorn main:app --host 0.0.0.0 --port $PORT
